...
import {
  ...
  setDebugUserTierOverride as persistDebugUserTierOverride,
...
export function UserSpectrumProvider({
  ...
  const [debugUserTierOverride, setDebugUserTierOverrideState] =
    useState<DebugUserTierOverride>(null);
  ...
  useEffect(() => {
    void hydrateDebugUserTierOverride().then(setDebugUserTierOverrideState);
  }, []);
  ...
  const applyDebugUserTierOverride = useCallback(async (value: DebugUserTierOverride) => {
    await persistDebugUserTierOverride(value);
    setDebugUserTierOverrideState(value);
  }, []);
