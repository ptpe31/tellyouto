...
- **Pass 2 LIST/PROJECT (mai–juin 2026)** : `geminiEnrichGenericList` — prompt inline `PASS2_*_INLINE_PROMPT` / `PASS2_PROJECT_TRAVEL_PROMPT` · **PROJECT** : `responseMimeType: application/json` · `maxOutputTokens: 4096` · modèle RC **`gemini-pro-latest`**. Parser jalons : `parseGeminiProjectMilestonesJsonWithMeta` + `jsonSalvage.ts` (réutilise logique LIST). Fallback jalons voyage : `buildFallbackTravelProjectMilestones`. UI : bandeau erreur + retry, brief voyage en gate Zen, `pass2_unlocked` après succès uniquement.
...
- **Inbox / hubs** : [`hubProcessModel.ts`](file:///Users/lala/Dev/trankil-v3/Dev-trankil-v34/src/utils/hubProcessModel.ts) + `buildInboxRootsView` sur tout pool ; [`hubDeleteModel.ts`](file:///Users/lala/Dev/trankil-v3/Dev-trankil-v34/src/utils/hubDeleteModel.ts) (résolution cascade Phase 2) ; [`IdeaBankModal`](file:///Users/lala/Dev/trankil-v3/Dev-trankil-v34/src/components/IdeaBankModal.tsx) + [`HubSelectionRing`](file:///Users/lala/Dev/trankil-v3/Dev-trankil-v34/src/components/HubSelectionRing.tsx) + [`TravelMilestoneInboxRows`](file:///Users/lala/Dev/trankil-v3/Dev-trankil-v34/src/components/TravelMilestoneInboxRows.tsx) + [`HubTaskCheckbox`](file:///Users/lala/Dev/trankil-v3/Dev-trankil-v34/src/components/HubTaskCheckbox.tsx).
