...
import { insertPhoenixIntentionDraft, updatePhoenixIntention } from '../services/storage/intentionsDb';
...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: '#0b1220', justifyContent: 'center', alignItems: 'center', padding: 16 },
});
