...
- **Inbox (Option B, juin 2026)** : regroupement sync via `buildZoomInboxView` ; ancres masquées ; [`TravelMilestoneInboxRows`](file:///Users/lala/Dev/trankil-v3/Dev-trankil-v34/src/components/TravelMilestoneInboxRows.tsx) — panneau zoom, cases jalon/sous-tâches, sections Terminé, badge parent `x/N`.
